...
public class App {
    public static void main(String...args){
        ...
        //ask for city and convert it to utf8
        ...
        try {
            ...
            System.out.println(finReport.getSys().printCountry());
            ...
            List<Weather> weatherList=finReport.getWeather();
            weatherList.stream()
                    .map(Weather::to_String)
                    .forEach(System.out::println);

            System.out.println(finReport.getSys().to_String());
